...
describe Enumerable do
  ...
  describe '#my_each' do
    ...
    context 'If a block is given and is an array' do
      ...
      it 'yields the result' do
        ...
        expect(self_array).not_to eq([15])
      end
    end
    ...
    context 'If a block is given and is a hash' do
      ...
      it 'yields the result' do
        ...
        expect(self_hash).not_to eq(['Negative test case'])
      end
    end
    ...
    context 'If a block is given and is a range' do
      ...
      it 'yields results in the range' do
        ...
        expect(self_array).not_to eq([25, 30, 41])
      end
    end
  end
  ...
  describe '#my_each_with_index' do
    ...
    context 'If a block is given and is an array' do
      ...
      it 'yields hash with index of an element' do
        ...
        expect(self_hash).not_to eq({ 0 => 'negative', 1 => 'test', 2 => 'case', 3 => 'vic', 4 => 'Oni' })
      end
    end
    ...
    context 'If a block is given and is a hash' do
      ...
      it 'yields hash with index of a value' do
        ...
        expect(self_hash).not_to eq({ [:eight, 1] => 0, [:two, 1] => 2, [:three, 3] => 2 })
      end
    end
    ...
    context 'if a block is given and is a range' do
      ...
      it 'yields hash with index of a value and range' do
        ...
        expect(self_hash).not_to eq({ 6 => 0, 4 => 1, 63 => 21, 75 => 3 })
      end
    end
  end
  ...
  describe '#my_select' do
    ...
    context 'If a block is given and is an array' do
      ...
      it 'yields the selected result' do
        ...
        expect(self_array).not_to eq([2, 3, 55, 7])
      end
    end
    ...
    context 'If a block is given and is a hash' do
      ...
      it 'yields the selected result' do
        ...
        expect(self_hash).not_to eq({ big: 1, bang: 5 })
      end
    end
    ...
    context 'If a block is given and is a range' do
      ...
      it 'yields the selected result in range' do
        ...
        expect(self_array).not_to eq([5, 66])
      end
    end
  end
  ...
  describe '#my_all?' do
    context 'If no block given' do
      ...
      it 'returns true' do
        empty_array = []
        expect(empty_array.my_all?).not_to be_falsey
      end
    end
    ...
    context 'If a block is given and checks the class' do
      ...
      it 'returns true' do
        self_array = array.all?(Numeric)
        expect(self_array).not_to be_falsey
      end
    end
    ...
    context 'If a block is given and does not checks the class' do
      ...
      it 'returns false' do
        self_array = array.all?(Float)
        expect(self_array).not_to be_truthy
      end
    end
  ...
  describe '#my_any?' do
    context 'If no block given' do
      ...
      it 'returns false' do
        empty_array = []
        expect(empty_array.my_any?).not_to be_truthy
      end
    end

    context 'if any block is given' do
      it 'returns true' do
        nil_array = [nil, 1]
      ...
      it 'returns false' do
        nil_array = [nil, 1]
        expect(nil_array.my_any?).not_to be_falsey
      end
    end
    ...
    context 'If a block is given and any conditions do not pass' do
      it 'returns false' do
        self_array = array.any? do |num|
          num > 10
        end
  ...
  describe '#my_none?' do
    ...
    context 'if block given is nil' do
      ...
      it 'does not returns true' do
        empty_array = [1]
        expect(empty_array.my_none?).to be_falsey
      end
    end
    ...
    context 'If a block is given and checks the class' do
      ...
      it 'returns false' do
        self_array = array.my_none?(String)
        expect(self_array).to be_truthy
      end
    end
    ...
    context 'If a block is given and does not checks the class' do
      it 'returns true' do
        self_array = string_array.my_none?(String)
        expect(self_array).to be_falsey
      end
    ...
    context 'If a block is given and all conditions do not pass' do
      it 'returns ture' do
        self_array = array.my_none? do |num|
          num > 10
        end
  ...
  describe '#my_count' do
    context 'If a block is not given and argument is not given' do
      ...
      it 'returns the size of the instance' do
        self_array = array.my_count
        expect(self_array).not_to eq(10)
      end
    end
    ...
    context 'If block is given and argument is not given' do
      ...
      it 'returns the total number of items that meet the condition' do
        expect(%w[dan oni dan oni dan uzair].my_count { |word| word == 'dan' }).not_to eq(4)
      end
    end
    ...
    context 'If block is given and argument is given' do
      ...
      it 'returns the total number of items that meet the condition' do
        expect(%w[dan oni vic oni dan uzair vic].my_count('dan') { |word| word == 'dan' }).not_to eq(4)
      end
    end
    ...
    context 'if block given' do
      ...
      it 'returns number of items that meet the condition' do
        expect(string_array.my_count { |word| word.length > 3 }).not_to eq(4)
      end
    end
  end
  ...
  describe '#my_map' do
    ...
    context 'If a block is given and is an array' do
      ...
      it 'returns a new array matching the conditions' do
        new_array = array.my_map { |i| i + 1 }
        expect(new_array).not_to eq([1, 2, 3, 4, 5, 6, 7, 8])
      end
    end

    context 'If a block is given and is a hash' do
      it 'returns a new array matching the conditions' do
        self_hash = hash.my_map { |_i, v| v + 1 }
        expect(self_hash).to eq([2, 3, 4])
      end

      it 'returns a new array matching the conditions' do
        new_hash = hash.my_map { |_i, v| v + 1 }
        expect(new_hash).not_to eq([1, 2, 3])
      end
    end
  end
  ...
  describe '#my_inject' do
    ...
    context 'If a block is given and argument is given' do
      ...
      it 'does not returns the largest word from string_array' do
        new_array = string_array.my_inject([]) { |memo, word| memo.size > word.size ? memo : word }
        expect(new_array).not_to eq('uzair')
      end
    end
  end
end
